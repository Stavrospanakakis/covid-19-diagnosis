...
In order to be able to detect if a patient suffers from COVID-19 or not, we created the “CovidvsNonCovid” network. For the classifications where used the Loss function which was used is Categorical Cross Entropy and the last’s layer function is Softmax because there were 3 different labels \par
