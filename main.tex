...
\section{COVnet-101}
Except from reviewing papers, we decided to create a custom network based on ResNet-101\cite{resnet}. 

- add information about resnet 
- mention datasets (which are , no of images, labels, validation/train)
- mention evaluation method
- mention input shape
- mention parameters
- mention image proccessing
- mention binary and categorical crossentropy
- mention description of the models
